...
/**
 * @file Describe the IAP commands interface on NXP LPC176x MCUs.
 *
 ...
 *
 * @note For details about IAP see the UM10360 LPC176x user manual,
 *       chapter 32: LPC176x/5x Flash memory interface and programming
 */

#ifndef LPC176X_IAP_H_
#define LPC176X_IAP_H_

/* Pointer to IAP function. */
#define IAP_ENTRY_ADDR			0X1FFF1FF1

/* TODO: Check all commands and codes */
