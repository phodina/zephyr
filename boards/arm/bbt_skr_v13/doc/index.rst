...
The BIGTREETECH development board uses an NXP LPC1768 MCU based
on an ARM Cortex-M3 core.

.. figure:: bigtreetech_skr_v13.png
   :width: 800px
   :align: center
   :alt: BIGTREETECH_SKR_V1.3

Hardware
********

The BIGTREETECH SKR V1.3 board provides the following hardware components:

- LPC1768 microcontroller in LQFP100 package
- ARM Cortex-M3
- Memory:
